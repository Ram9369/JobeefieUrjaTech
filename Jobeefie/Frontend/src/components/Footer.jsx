...
>>>>>>> 7ee9aa8c4ab8f8219d197dbe87d4e924a52f53ae
import React from "react";
import { motion } from "framer-motion";
import {
  Phone,
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/35">
          ...
          <p className="order-3 flex items-center gap-1 text-white/30">
            ...
            <a
              ...
              rel="noopener noreferrer"
<<<<<<< HEAD
              className="text-white hover:text-[#FFC107] underline-offset-2 hover:underline transition-all duration-200 ml-0.5"
            >
              Ram Pratap Maurya
            </a>{" "}
            &amp;{" "}
...
>>>>>>> 7ee9aa8c4ab8f8219d197dbe87d4e924a52f53ae
            <a
              ...
              rel="noopener noreferrer"
<<<<<<< HEAD
              className="text-white hover:text-[#FFC107] underline-offset-2 hover:underline transition-all duration-200"
            >
              Himanshu
            </a>{" "}
            · Powered by{" "}
